...
<style>body{font-family:sans-serif;background:#121212;color:#fff;display:flex;align-items:center;justify-content:center;height:100vh;margin:0;text-align:center;flex-direction:column;gap:14px}img{width:120px;height:120px;border-radius:16px;object-fit:cover}a{color:#bb86fc}</style>
</head>
<body>
